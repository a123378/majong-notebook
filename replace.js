...
export const HistoryView: React.FC = () => {
  ...
  const handleExportJSON = () => {
    ...
    downloadAnchor.setAttribute('download', \\\mahjong_history_\\\.json\\\);
      ...
      <div className="rounded-3xl p-5 sm:p-6 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 text-white border border-slate-800 shadow-xl relative overflow-hidden">
        ...
        <div className="my-2 text-center">
          ...
          <div className="flex items-baseline justify-center gap-1">
            <span
              className={\\\	ext-2xl font-black \\\\\\}
            >
              {isTotalPositive ? '+' : isTotalNegative ? '-' : ''}$
            </span>
            <span
              className={\\\	ext-4xl sm:text-5xl font-black font-mono tracking-tight \\\\\\}
            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div className="flex items-center gap-3 flex-shrink-0">
                                    <div
                                      className={\\\	ext-right font-mono font-black text-lg sm:text-xl \\\\\\}
                                    >
...
fs.writeFileSync('src/components/History/HistoryView.tsx', code, 'utf8');